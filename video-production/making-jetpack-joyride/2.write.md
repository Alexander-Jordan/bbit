...
I kept it simple though and just made the running and flying animations.
```
- Collisions and flying
```
I added some collisions and made him fly whenever you tapped the screen.
The particle effects I did were really simple, but I'm not an expert with them and I didn't want to stay here too long, so it was good enough.
```
...
Then the end screen appears, from which you could restart.
```
...
I made them collectible by the player, and added the UI to display the collected coins.
They are of course also saved between sessions, and in the future it would be cool to add powerups which you could buy with the coins.
...
And once again I re-iterated on the spawning system to make it work.
```
- Add audio
```
